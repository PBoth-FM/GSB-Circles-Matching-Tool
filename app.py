            ...
            if st.session_state.results is not None:
                ...
                if 'results' in st.session_state and st.session_state.results is not None:
                    ...
                    with col3:
                        ...
                        if 'matched_circles' in st.session_state and st.session_state.matched_circles is not None and results_df is not None:
                            matched_df = st.session_state.matched_circles
                            
                            # Process each circle to calculate diversity scores
                            for _, circle_row in matched_df.iterrows():
